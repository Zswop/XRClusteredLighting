...
namespace UnityEngine.Rendering.Universal
{
    ...
    public sealed class UniversalRenderer : ScriptableRenderer
    {
        ...
        ClusteredForwardLights m_ForwardLights;
        ...
        public UniversalRenderer(UniversalRendererData data) : base(data)
        {
            ...
            this.stripAdditionalLightOffVariants = false;

            ClusteredForwardLights.InitParams forwardInitParams;
            forwardInitParams.lightCookieManager = m_LightCookieManager;
            forwardInitParams.clusteredRendering = data.clusteredRendering;
            forwardInitParams.tileSize = (int)data.tileSize;
            m_ForwardLights = new ClusteredForwardLights(forwardInitParams);
            ...
            ref CameraData cameraData)
        {
            ...
            // }
            if (m_ForwardLights.useClusteredRendering)
            {
                cullingParameters.cullingOptions |= CullingOptions.DisablePerObjectCulling;
            }
